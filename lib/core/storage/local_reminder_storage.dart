  ...
  List<ReminderModel> get _defaultReminders {
    ...
    return [
      ...
      ReminderModel(
        ...
        type: 'Respiración consciente',
        title: 'Respiración consciente',
        subtitle: 'Pausa breve de 3 minutos',
        hour: 7,
        minute: 30,
        days: const [1, 3, 5],
        enabled: true,
      ...
      ReminderModel(
        id: 'reminder_triage_monthly',
        type: 'Triaje emocional',
        title: 'Triaje emocional',
        subtitle: 'Revisar tu bienestar emocional',
        hour: 18,
        minute: 0,
        days: const [1],
        enabled: false,
